      ...
      <button
        className={cn(
          ...
          // Variant styles
          {
            ...
            "shadow-md shadow-primary/[0.15] hover:shadow-lg hover:shadow-primary/[0.2]":
              variant === "primary",
            // Dark mode - stronger shadows
            "dark:shadow-lg dark:shadow-primary/20 dark:hover:shadow-xl dark:hover:shadow-primary/30":
              variant === "primary",
            ...
            "shadow-md shadow-destructive/[0.15] hover:shadow-lg hover:shadow-destructive/[0.2]":
              variant === "destructive",
            // Dark mode - stronger shadows
            "dark:shadow-lg dark:shadow-destructive/20 dark:hover:shadow-xl dark:hover:shadow-destructive/30":
              variant === "destructive",
