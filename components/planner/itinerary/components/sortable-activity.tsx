...
export function SortableActivity({
    ...
    return (
        <div ref={setNodeRef} style={style} {...attributes} {...listeners}>
            <ActivityCard
                activity={activity}
                className={`mb-3 transition-all border-b-4 border-r-4 border-b-primary/40 border-r-primary/40 hover:border-b-primary hover:border-r-primary ${isDragging ? 'shadow-2xl cursor-grabbing' : 'hover:shadow-md cursor-grab'
                    }`}
