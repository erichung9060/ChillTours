    ...
    days: [
      {
        ...
        activities: [
          ...
          },
          {
            ...
            description:
              "Visit the famous scramble crossing and surrounding area",
            location: {
      ...
      },
      {
        ...
        activities: [
          ...
          },
          {
            ...
            description:
              "Explore the electric town and have dinner at a themed cafe",
            location: {
        ...
        activities: [
          {
            ...
            title: "Meiji Shrine",
            description:
              "Peaceful shrine surrounded by forest in the heart of Tokyo",
            location: {
              name: "Meiji Shrine",
              lat: 35.6764,
              lng: 139.6993,
